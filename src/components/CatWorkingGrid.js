...
export default function CatWorkingGrid({
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      {/* Working grid (3 columns x 2 rows) */}
      <div className="grid grid-cols-3 gap-x-6 gap-y-2 max-w-lg w-full mt-4">
        {Array.from({ length: 6 }).map((_, idx) => {
          ...
          return (
            <div
              ...
              className="h-28 flex flex-col items-center justify-center relative cursor-pointer p-2 border border-dashed border-transparent hover:border-[#fda4af]/30 rounded-md transition-all active:opacity-75"
            >
              {cat ? (
                <>
                ...
                <div className="flex flex-col items-center gap-1 opacity-45 hover:opacity-100 transition-opacity">
                  ...
                  <span className="text-[8px] font-mono text-zinc-650 italic">
                    Empty Desk
                  </span>
                </div>
              )}
